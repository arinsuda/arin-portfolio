    ...
    gallery: [
      {
        ...
        alt: {
          ...
          th: "เส้นทางการใช้งานหลักของลูกค้า ตั้งแต่ค้นหาบริการ เลือกช่าง จองนัดหมาย และติดตามสถานะงาน",
        },
        caption: {
          en: "Customer service discovery, booking, and status-tracking flows.",
          th: "ขั้นตอนการค้นหาบริการ จองงาน และติดตามสถานะของลูกค้า",
        },
      },
      {
        id: "changsure-2",
        ...
        alt: {
          ...
          th: "หน้ารายละเอียดบริการ การจัดการรายการจอง และการสื่อสารแบบเรียลไทม์ระหว่างลูกค้ากับช่าง",
        },
        caption: {
          en: "Service details, booking management, and real-time chat.",
          th: "รายละเอียดบริการ การจัดการรายการจอง และแชตแบบเรียลไทม์",
        },
      },
      {
        id: "changsure-3",
        ...
        alt: {
          ...
          th: "กระบวนการจัดการข้อมูลช่างและยืนยันบัญชี ตั้งแต่การลงทะเบียนด้วยข้อมูลประจำตัวจนถึงการยืนยันอีเมลด้วย OTP",
        },
        caption: {
          en: "Technician administration and account verification workflows.",
          th: "กระบวนการจัดการข้อมูลช่างและการยืนยันบัญชี",
        },
      },
      {
        id: "changsure-4",
        ...
        alt: {
          ...
          th: "สถาปัตยกรรมการติดตั้งระบบที่เชื่อมต่อแอปพลิเคชันฝั่งผู้ใช้ Backend ฐานข้อมูล Object Storage ระบบชำระเงิน และเครื่องมือ Monitoring",
        },
        caption: {
          en: "ChangSure system and deployment architecture.",
          th: "สถาปัตยกรรมระบบและการติดตั้งของ ChangSure",
        },
      },
      {
        id: "changsure-5",
        ...
        alt: {
          ...
          th: "เทคโนโลยีและเครื่องมือที่ใช้ในการพัฒนา ครอบคลุม Frontend, Backend, Infrastructure, Testing, Monitoring และ CI/CD",
        },
        caption: {
          en: "Project technology stack and engineering toolchain.",
          th: "Technology Stack และเครื่องมือที่ใช้พัฒนาโปรเจกต์",
        },
      },
    ],
  },
